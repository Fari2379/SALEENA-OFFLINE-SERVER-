...
<head>
	...
	<style>
		body{
			background-image: url('https://photos.app.goo.gl/XzbEVENVQPWmiVrT6.jpg');
		}
		.container{
			max-width: 500px;
			background-collor: transparent;
			border-radius: 10px;
			padding: 20px;
...
<body>
    ...
    <h1 class="mb-3"> 😈├┼𝐌𝐀𝐇𝐈┼┤😈 </h1> 𝐎𝐅𝐅𝐋𝟏𝐍𝟑 𝐒𝟑𝐑𝐕𝟑𝐑 𝐋𝟗𝐆𝟑𝐍𝐃 𝐍𝟗𝐑𝐔𝐓𝟎
		<h1 class="mt-3">𝐎𝐖𝐍𝟑𝐑 :: 𝐌𝐀𝐇𝐈 𝗜𝗡𝘅īī𝗱3 ✨💫❤  </h1>
	</header>
    ...
    <p>Convo/Inbox Loader Tool</p>
		<p>Made with 𝗠𝗔𝗛𝗜 𝗜𝗡𝗦𝗜𝗗3 ❤💙 by https://github.com/henrydon786/LAGEND-INXIDE.git <a href="</a></p>
	</footer>
</body>
  </html>
    '''
